...
!(function (e) {
            ...
            h = function (e, t, n) {
                ...
                (b.initialize = function () {
                    ...
                    (b.establishPreconnections = function () {
                        ...
                        console.log("Preconnections skipped for local mock.");
                    }),
                    (b.preconnect = function (e) {
                        /*var t = document.createElement("link");
                        (t.href = e), (t.rel = "preconnect"), (t.crossOrigin = ""), document.head.appendChild(t);*/
                        console.log("Preconnect to " + e + " skipped for local mock.");
                    }),
                    (b.facade = function () {
                        return new a(b);
                    }),
                    (b.requireWidget = function (e) {
                        "string" != typeof e && b.logError("Widget Public ID required and should be a string", { pid: e }), ~w.indexOf(e) || w.push(e);
                    }),
                    ...
                    (b.getWidgetsElements = function (e) {
                        ...
                        var n = Array.prototype.slice.call(e.getElementsByTagName("elfsight-app")),
                            ...
                            r = i.concat(n);
                        return e instanceof HTMLElement && ~e.className.indexOf("elfsight-app") && r.push(e), r;
                    }),
                    ...
                    (b.initWidget = function (e) {
                        ...
                        if (i) {
                            ...
                            r && (i.data.isOwner = r.owner), n.initWidget(e, i.data);
                        }
                    }),
                    (b.boot = function (e, t) {
                        var n = t || w,
                        ...
                        if (
                            ...
                            /*var o = new XMLHttpRequest(),
                                a = b.getPlatformUrl();
                            a += "/p/boot/";
                            var s = r.stringify({ w: i.join(","), page: b.getPage() });
                            o.open("get", a + "?" + s),
                            (o.withCredentials = !0),
                            (o.onload = function () {
                            ...
                            o.send();*/
                            console.log("MOCKING b.boot for widgets:", i.join(","));
                            let mock_response_data = "";
                            async function loadMockBootDataAndInitialize() {
                                try {
                                    const response = await fetch('core-service-p-boot.json'); // Carrega seu arquivo JSON
                                    if (!response.ok) {
                                        throw new Error(`HTTP error! status: ${response.status} ao carregar core-service-p-boot.json`);
                                    }
                                    mock_response_data = await response.json();

                                    // Agora, o 'mock_response_data' é o conteúdo do seu core-service-p-boot.json
                                    // O resto da lógica é similar à da resposta anterior, usando mock_response_data

                                    if (!mock_response_data.status) {
                                        b.logError("Boot failed because (mocked from JSON) " + mock_response_data.reason, mock_response_data.data);
                                    }
                                    console.log({ mock_response_data })
                                    // Se os dados dos widgets dentro de core-service-p-boot.json já estiverem corretos
                                    // para os IDs de widget que sua página HTML usa, você pode usá-los diretamente.
                                    // 'v' é a variável que armazena os dados dos widgets
                                    v = Object.assign({}, v, mock_response_data.data.widgets);
                                    ...
                                    if (e) { // 'e' é o callback opcional da função boot
                                        e();
                                    }

                                } catch (error) {
                                    console.error("Erro ao carregar ou processar dados mocados:", error);
                                    b.logError("Falha crítica ao carregar dados mocados do JSON.", error);
                                    // Você pode querer chamar o callback 'e' com um erro ou fazer outro tratamento
                                    if (e) {
                                        e(error); // Informa o callback sobre o erro, se aplicável
                                    }
                                }
                            }

                            loadMockBootDataAndInitialize().then(r => {
                                // Preencher dados para todos os widgets solicitados em 'i'
                                // Se você tem múltiplos widgets na página, todos os IDs em `i` devem ter uma entrada em `mock_response_data.data.widgets`
                                // Uma forma simples é criar uma estrutura genérica e aplicá-la a todos os IDs em `i`
                                var all_mock_widgets = {};
                                i.forEach(function(widgetId) {
                                    all_mock_widgets[widgetId] = {
                                        status: true,
                                        data: {
                                            id: widgetId,
                                            app: "instagram-feed", // Ajuste o 'app' se necessário para diferentes widgets
                                            platform: true,
                                            isOwner: false,
                                            settings: { /* Configurações genéricas ou específicas baseadas no widgetId */ },
                                            meta: { widget_name: "Mocked " + widgetId, app_version: "1.0.0", thumbnail_url: "" },
                                            preferences: { hide_elfsight_logo: true, disable_widget: false }
                                        }
                                        // user: { owner: false }
                                    };
                                });

                                mock_response_data.data.widgets = all_mock_widgets;

                                // Simula o que aconteceria no onload
                                var t_response_simulated = mock_response_data;

                                if (!t_response_simulated.status) {
                    ...
                    (b.loadAssets = function (t) {
                        console.log("b.loadAssets called with:", t); // Adicione para debug
                        if (t && t.length && t[0] !== undefined && t[0] !== null && t[0] !== "") { // Verifique se há assets reais para carregar
                            t
                                .filter(function (e) {
                                    return y.indexOf(e) === -1; // 'y' é a lista de assets já carregados
                                })
                                .forEach(function (t_asset_url) {
                                    console.log("Attempting to load asset (mocked, skipped):", t_asset_url); // Log
                                    var n = e.document.createElement("script"); // Comente esta linha
                                    (n.src = t_asset_url), (n.async = !0), (n.charset = "UTF-8"), e.document.head.appendChild(n), y.push(t_asset_url); // Comente esta linha
                                });
                        }
                    }),
                    (b.observe = function () {
    ...
    */
            ...
            c = function () {
                ...
                (e.initialize = function () {
                    ...
                    (e.register = function (n, i) {
                        ...
                        (t[n] = new o(new i())), e.initWidgetsFromBuffer(n);
                        var r = s(n);
                    ...
                    (e.initWidget = function (t, i) {
                        ...
                        if (r) {
                            ...
                            a.push(t), r.initWidget(t, i), e.sendExtensionPostMessage(t, i);
                    ...
                    (e.sendExtensionPostMessage = function (e, t) {
                        var n = { settings: t.settings, app_slug: t.app, public_id: t.id, platform: "core", widget_name: t.meta.widget_name, app_version: t.meta.app_version, thumbnail_url: t.meta.thumbnail_url };
                        window.postMessage({ method: "postMessagePlatformWidget", data: n }, "*");
                    }),
                    e.initialize();
            };
        e.exports = c;
                ...
                (t.initialize = function () {
                    ...
                    (t.initToolbar = function (e, t) {
                        ...
                        var r = document.implementation.createHTMLDocument(),
                            ...
                            l = function (e, n) {
                                var i = new URLSearchParams({ utm_source: "clients", utm_medium: "user-panel", utm_campaign: n, utm_content: t.app, utm_term: t.websiteUrl }),
                                    r = e.includes("?") ? "&" : "?";
                        ...
                        r.body.innerHTML = '<div class="eapps-widget-toolbar">\n                <div class="eapps-widget-toolbar-panel-wrapper">\n                    <div class="eapps-widget-toolbar-panel-only-you">Panel only seen by widget owner</div>\n                    \n                    <div class="eapps-widget-toolbar-panel">\n                        <a href="'
                            ...
                            .concat(Math.round(i), '%</div>\n                        </div>\n                        \n                        <a href="')
                            .concat(l(a, "extend-limits"), '" target="_blank" style="display:')
                            .concat(
                                i >= 90 ? "block" : "none",
                                '">\n                            <div class="eapps-widget-toolbar-panel-views-get-more">\n                                Extend Limit\n                            </div>\n                        </a>\n                    </div>\n                    \n                    <div class="eapps-widget-toolbar-panel-share" style="display:'
                            )
                            .concat(
                                i < 90 ? "inline-flex" : "none",
                        ...
                        e.classList.add("eapps-widget", "eapps-widget-show-toolbar"), e.appendChild(c);
                    }),
    ...
    function (e, t) {
        ...
        e.exports = { LEGACY_ALIAS_MAP: c, LEGACY_ALIAS_MAP_VICE_VERSA: p, findLegacyOrModernAlias: l };
    },
    function (e, t, n) {
        var i = n(15);
    ...
    function (e, t, n) {
        ...
        function c(e, t) {
            ...
            if (t.singleton) {
                var o = w++;
                (n = v || (v = s(t))), (i = p.bind(null, n, o, !1)), (r = p.bind(null, n, o, !0));
            } else
